...
+ (UIImage *)cod_imageWithColor:(UIColor *)color {
    return [self cod_imageWithColor:color rect:CGRectMake(0, 0, 1, 1)];
}

+ (UIImage *)cod_imageWithColor:(UIColor *)color size:(CGSize)size {
    return [self cod_imageWithColor:color rect:CGRectMake(0, 0, size.width, size.height)];
}

+ (UIImage *)cod_imageWithColor:(UIColor *)color rect:(CGRect)rect {
