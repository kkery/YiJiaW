...
@interface CODBrowserPhotoView ()<UIScrollViewDelegate>{
...
@implementation CODBrowserPhotoView
...
//                [self.imageView sd_setImageWithURL:[NSURL URLWithString:photoUrl] placeholderImage:[UIImage imageNamed:@"ic-zanwu@3x"]  completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
//                    self.imageView.frame=[self caculateOriginImageSizeWith:image];
//                    if (!isInCache) {
//                        //                    [HUD hide:YES];
//                    }
                    [self.imageView sd_setImageWithURL:[NSURL URLWithString:photoUrl] placeholderImage:[UIImage imageNamed:@"ic-zanwu@3x"] options:SDWebImageRetryFailed completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                         self.imageView.frame=[self caculateOriginImageSizeWith:image];
                    }];
//                }];
...
-(UIImageView *)imageView{
    ...
    if (_imageView==nil) {
        ...
        UILongPressGestureRecognizer *longPressTap = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(SaveImgTapClicked:)];
        ...
        [_imageView addGestureRecognizer:longPressTap];
...
-(void)SaveImgTapClicked:(UILongPressGestureRecognizer *)gesture{

    UIImageView *view = (UIImageView *)gesture.view;
    [self.delegate SaveImageToNativeWithImg:view.image];
}
