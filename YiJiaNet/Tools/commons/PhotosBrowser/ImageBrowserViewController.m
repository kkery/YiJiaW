...
//        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:255 green:255 blue:255 alpha:1];
//        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:135 green:135 blue:135 alpha:1];
