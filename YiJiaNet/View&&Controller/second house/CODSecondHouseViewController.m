//
//  CODSecondHouseViewController.m
//  YiJiaNet
//
...
#import "CODSecondHouseViewController.h"
#import "CODSecondHouseTableViewCell.h"
...
static NSString * const kCell = @"CODSecondHorseTableViewCell";

@interface CODSecondHouseViewController () <UITableViewDataSource, UITableViewDelegate, MJRefreshEXDelegate>
// 顶部导航栏组件
...
@implementation CODSecondHouseViewController
...
- (void)viewDidLoad {
    ...
    self.tableView = ({
        ...
        [tableView registerClass:[CODSecondHouseTableViewCell class] forCellReuseIdentifier:kCell];
        tableView;
    });
    ...
    self.saleButton = ({
        ...
        [button setImage:[UIImage imageNamed:@"secondary_sell"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"secondary_sell"] forState:UIControlStateHighlighted];
        [button addTarget:self action:@selector(saleAction) forControlEvents:UIControlEventTouchUpInside];
        button;
    });
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    CODSecondHouseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kCell forIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [CODSecondHouseTableViewCell heightForRow];
}
...
#pragma mark - Action
- (void)saleAction {
    CODSaleInputViewController *searchVC = [[CODSaleInputViewController alloc] init];
